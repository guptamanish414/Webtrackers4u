	...
	if($_FILES[$name]['name']!="")
			{
				...
				$rand='rosettamcdermott'.rand(100,999);
				 $New_File_Name=$rand."_".$_FILES[$name]['name'];
 ...
 $email=new activeMailLib("html");
		...
		*/
		...
		if(is_array($attachments))
		{
		    ...
		    $email->Attachment($attachments['file'],$attachments['filename'],$attachments['maxsize'],$disp="attachment",$attachments['type']);

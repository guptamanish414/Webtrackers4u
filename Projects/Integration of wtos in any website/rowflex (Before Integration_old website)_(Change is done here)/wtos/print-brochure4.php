...
<!--<div style="margin:auto; text-align:center; margin-bottom:2px; display:none;">
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="left" valign="middle" style="background:#a61d43; padding:0px 0px 0px 0px; height:102px;">
		<table width="100%" border="0">
				  <tr>
					<td align="left" valign="middle"><img src="<?php echo $site['themePath']?>images/b_logo.jpg" border="0" width="224" height="101" /></td>
					<td align="right" valign="middle"><img src="<?php echo $site['themePath']?>images/adress.jpg" border="0" width="460" height="101" /></td>
				  </tr>
	  </table>
  ...
  <tr>
    <td align="left" valign="top">
		...
		<span style="position:absolute; left:1058px; top:700px;">
	 	<span><img src="<?php  echo $qrImg;?>" border="0" width="150" height="150"/></span>
	</span>
	...
	<? 
	 ...
	 ?>
	 <img src="<?php  echo $bigImg;?>" border="0" width="1190" height="734"/>
  ...
  <tr>
    <td align="left" valign="middle" style=" border:1px solid #FF0000;">
		<table width="0" border="0" cellpadding="0" cellspacing="0" style=" border:1px solid #0066FF;">
			  <tr>
				...
				<?
				   ...
				   <img src="<?php echo $site['themePath']?>images/red_line02.jpg" border="0" width="264" height="4"/>
		           <img src="<? echo $smallImg2; ?>" border="0"  width="400" height="<? echo $heightSmallImage ?>"/>
				   <img src="<?php echo $site['themePath']?>images/red_line03.jpg" border="0" width="264" height="5"/>
		           <img src="<? echo $smallImg3; ?>" border="0"  width="400" height="<? echo $heightSmallImage ?>"/>
				   <img src="<?php echo $site['themePath']?>images/red_line04.jpg" border="0" width="264" height="18"/>
				</td>
				<td width="29" align="left" valign="middle">&nbsp;</td>
				<td width="230" align="left" valign="top">
					<span style="font-family:'Myriad Pro'; font-size:17px; color:#a61d43; line-height:23px; padding-top:25px;"><?php echo stripslashes($pro['shortDescription'])?>.</span>
			 ...
			 <tr>
								<td  style="font-family:'Myriad Pro'; font-size:18px; color:#a61d43; font-weight:bold; padding-top:5px;">Ground Rent:<?php echo $pro['groundrent']?> </td>
							  </tr>
			<? } ?>
			
				 <tr>
								<td  style="font-family:'Myriad Pro'; font-size:18px; color:#a61d43; font-weight:bold; padding-top:5px;"><?php echo $pro['leasehold']?>:<?php if( $pro['leaseyears']!=''){?>   <?php echo $pro['leaseyears']?> Years <? }?> Years</td>
							  </tr>
			...
			<?php if( $pro['leasehold']=='Leasehold' || $pro['leasehold']=='Share of Freehold'  ){?> 
			 <tr>
								...
								<td  style="font-family:'Myriad Pro'; font-size:18px; color:#a61d43; font-weight:bold; padding-top:5px;">Service Charge: <?php echo $pro['servicecharge']?></td>
							  </tr>
			...
			<? } ?>
				...
				<td width="250" align="left" valign="top"><img src="<? echo $floorPlanImg; ?>" border="0"  width="250" height="600"  /></td>
			  </tr>
	  </table>
    ...
    <td align="left" valign="middle">
		<table width="0" border="0" cellpadding="0" cellspacing="0">
			  <tr>
				<td width="400" align="left" valign="top">
			       <img src="<?php echo $site['themePath']?>images/red_line.jpg" border="0" width="264" height="14"/>
		           <img src="<? echo $smallImg1; ?>" border="0"  width="400" height="240"/>
				   <img src="<?php echo $site['themePath']?>images/red_line02.jpg" border="0" width="264" height="4"/>
		           <img src="<? echo $smallImg2; ?>" border="0"  width="400" height="240"/>
				   <img src="<?php echo $site['themePath']?>images/red_line03.jpg" border="0" width="264" height="5"/>
		           <img src="<? echo $smallImg3; ?>" border="0"  width="400" height="240"/>
				   <img src="<?php echo $site['themePath']?>images/red_line04.jpg" border="0" width="264" height="18"/>
				</td>
				<td width="29" align="left" valign="middle">&nbsp;</td>
				<td width="230" align="left" valign="top">
					<span style="font-family:'Myriad Pro'; font-size:17px; color:#a61d43; line-height:23px; padding-top:15px;"> <?php echo stripslashes($pro['shortDescription'])?>.</span>
					...
					<span>
						<table width="100%" border="0">
							  <tr>
								<td  style="font-family:'Myriad Pro'; font-size:16px; color:#a61d43; font-weight:bold; padding-top:5px;">Underground: <?php echo $pro['underground']?> <br />
Earls Court,Shepards Bush</td>
							  </tr>
							  <tr>
								<td  style="font-family:'Myriad Pro'; font-size:16px; color:#a61d43; font-weight:bold; padding-top:5px;">Council Tax: <?php echo $pro['counciltax']?><!--&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-family:'Myriad Pro'; font-size:16px; color:#a61d43; font-weight:bold; padding-top:5px;">EPC:&pound;100</span>--></td>
							  </tr>
							  <tr>
								<td  style="font-family:'Myriad Pro'; font-size:18px; color:#a61d43; font-weight:bold; padding-top:5px;">&nbsp;</td>
							  </tr>

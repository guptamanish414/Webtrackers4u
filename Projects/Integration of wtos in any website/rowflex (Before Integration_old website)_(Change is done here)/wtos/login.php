...
<table width="400" border="0" cellspacing="0" cellpadding="3">
  ...
  <a href="http://webhouse4u.co.uk/" title=" " target="_blank">
	<img src="<?php echo $site['url'] ?>image/poweredBy.png" alt="" width="30"   style="margin:0 0 0 5px; border:none;"/></a>
  </td>
...
<script type="text/javascript" language="javascript">
  var p="<?php echo $site['url'].'dashBoard.php'?>";
	...
	window.location="<?php echo $site['url'].'aaorganizer.php'?>";

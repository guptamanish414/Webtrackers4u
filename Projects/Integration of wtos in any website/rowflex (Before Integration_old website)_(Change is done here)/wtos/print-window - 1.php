...
<div style="width:595px; margin:auto;">
 <div>
	...
	<div><img src="<?php echo $bigImg?>" border="0" width="595" height="334" /></div>
	<div style="background:#a3013d; height:5px;">&nbsp;</div>
	<div>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left" valign="middle"><img src="<?php echo $smallImg1?>" border="0"  width="199" height="144"  /></td>
    <td align="left" valign="middle"><img src="<?php echo $smallImg2?>" border="0"  width="199" height="144"  /></td>
    <td align="left" valign="middle"><img src="<?php echo $smallImg3?>" border="0"   width="199" height="144"  /></td>
  </tr>
</table>
...
<div>	
	<div>
		<div style="width:420px; float:left; height:49px; background:#a3003b;">
		...
		<div style="width:175px; float:left; height:49px; background:#f1ecda;">
  ...
  <tr>
    ...
    <td align="left" valign="middle"><img src="<?php echo $site['url']?>wtos-theme/images/rupia.jpg" border="0" /></td>

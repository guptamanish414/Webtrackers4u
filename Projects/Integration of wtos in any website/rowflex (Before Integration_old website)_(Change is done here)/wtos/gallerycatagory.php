...
$DivIds['AJAXPAGE']='gallerycatagoryEdit';
$primeryTable='gallerycatagory';
$primeryField='galleryCatagoryId';
$listHeader='GALARY CATEGORY DETAILS';
...
if(varP('operation'))
{
	 ...
	 if(varP('operation')=='updateField')
	 {
	  ...
	  $dataToSave['categoryName']=varP('categoryName');
...
$andUser=$os->andField('name_search','categoryName',$primeryTable,'%');	
...
?>
	...
	<table class="container">
			  ...
			  <table cellpadding="0" cellspacing="0">
							...
							Category Name:<input type="text" name="name_search" id="name_search" value="<?php echo $name_search?>" style="width:100px;" />
							
							Status:
						&nbsp;
							<select name="active" id="active_search"  onchange="javascript:window.location='<? $seoLink->getLink('gallerycatagory',true); ?>?active='+this.value"><?php $os->onlyOption($statuslist,$active);	?>
							</select>
							&nbsp;
				 ...
				 <table  border="0" cellspacing="0" cellpadding="0" class="listTable" >
							...
							<tr class="border"  onmouseover="javascript:miz.switchRow('<?php echo  $DivIds['BUTTONS']; ?>')">
								...
								<td><?php $os->changeStatusDD($status,$record['active'],'gallerycatagory','active','galleryCatagoryId',$DivIds['EDITID'],$colorStatus); ?>  </td>
								  <td class="actionLink">                   

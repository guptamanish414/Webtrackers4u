	  ...
	  function dAK($code,$key='')
	  {
	     if($code!=''){
					   ...
					   if(strlen($code)==8)
					   {
						 ...
						 mysql_query("update settings set value='$codeBase64' where keyword='Validate WtosDate' ");
...
<style>
.boxContainer{ margin:auto; width:500px; margin-top:200px; height:100px;}
.activationCode{ height:38px; width:500px; font-size:25px; font-weight:bold; color:#383838;  }

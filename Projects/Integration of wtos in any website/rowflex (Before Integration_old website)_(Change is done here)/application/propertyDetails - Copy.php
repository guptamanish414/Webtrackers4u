        	...
        	<div class="row">
            	...
            	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                	...
                	<div class="product-title">
                        ...
                        <span class="prop-price pull-right">

							<? echo $GLOBALS['currency']; ?><strong><?php echo  number_format( $pro['price'])?></strong><?php echo $pro['priceUnit']?>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="tab2" class="tab-pane fade">
                                ...
                                <div class="google_map">
                                        ...
                                        <div style="overflow:hidden;width:100%;height:300px;resize:none;max-width:100%; position:relative;">
                            ...
                            <div id="tab3" class="tab-pane fade">
                                ...
                                <div class="foor_plan">
                                 	...
                                 	<img src="<?php echo $site['themePath']?>images/floor_-plan.jpg">
                    	...
                    	<div class="row">
                            ...
                            <div class="col-md-4">
                            	...
                            	<div class="right_book">
                                    ...
                                    <div class="whiteblock">020 3632 7395</div>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content Enquiry_from">
			...
			<div class="modal-header ">
				...
				<h4 class="modal-title"><?php echo "Enquiry for: ";  echo $pro['title'] ?></h4>

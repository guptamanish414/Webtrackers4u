<div class="search_box">
                ...
                <? $locations=$os->get_propertylocation(" active=1",' title ','');
                      ...
                      <?  } ?>
                            ...
                            <div class="form-group" id="letFromPriceHolder" style="display:'';" >
                      ...
                      <?  } ?>
                            ...
                            <div class="form-group"  id="letToPriceHolder" style="display:'';">
                      ...
                      <?  } ?>
						    ...
						    <div class="form-group" id="buyFromPriceHolder" style="display:none;" >
                          ...
                          <option  value="0">&nbsp;No Limit</option>
                            ...
                            <div class="form-group"   id="buyToPriceHolder" style="display:none;" >
                                <label class="label-text">Maximum Price</label>
                      ...
                      <option value="Commercial">Commercial</option>
                           ...
                           <a href="javascript:void(0)" onClick="searchProp()" class="button">Search</a>
                        </form>

...
$url['addProperty']='https://adfapi.adftest.rightmove.com/v1/property/sendpropertydetails';
$url['deleteProperty']='https://adfapi.adftest.rightmove.com/v1/property/removeproperty';
$url['getBranch']='https://adfapi.adftest.rightmove.com/v1/property/getbranchpropertylist ';
		...
		$body=	'
{
	...
	"property":{
		...
		"details":{
			"summary": "'.addslashes($pro['shortDescription']).addslashes($pro['fullDescription']).'",
...
curl_setopt($ch, CURLOPT_SSLCERTPASSWD, "iaPJ2Ofm");

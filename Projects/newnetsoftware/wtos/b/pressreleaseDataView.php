...
From releaseDate: <input class="wtDateClass" type="text" name="f_releaseDate_s" id="f_releaseDate_s" value=""  /> &nbsp;   To releaseDate: <input class="wtDateClass" type="text" name="t_releaseDate_s" id="t_releaseDate_s" value=""  /> &nbsp;  
   active:

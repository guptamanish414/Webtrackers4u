...
<div class="linkClassDiv  <? echo selectedPage('pressreleaseDataView.php') ?>" >  <a class="linkClass"    href="<? echo $site['url-wtos'] ?>pressreleaseDataView.php">Press Release</a></div>
